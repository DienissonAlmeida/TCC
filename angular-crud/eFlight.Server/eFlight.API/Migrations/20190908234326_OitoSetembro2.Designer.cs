...
namespace eFlight.API.Migrations
{
    ...
    [Migration("20190908234326_OitoSetembro2")]
    partial class OitoSetembro2
    {
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Flights.FlightReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FlightId = 1,
                            InputDate = new DateTime(2019, 9, 8, 23, 43, 25, 537, DateTimeKind.Utc).AddTicks(3315),
                            OutputDate = new DateTime(2019, 9, 18, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
