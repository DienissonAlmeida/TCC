...
namespace eFlight.API.Migrations
{
    ...
    [Migration("20191019142946_19-10")]
    partial class _1910
    {
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Cars.Car", b =>
                {
                    ...
                    b.Property<int>("RegisteredVancancies");
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Cars.CarReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CarId = 1,
                            InputDate = new DateTime(2019, 10, 19, 11, 29, 45, 643, DateTimeKind.Local).AddTicks(5607),
                            Name = "Dienisson",
                            OutputDate = new DateTime(2019, 10, 29, 11, 29, 45, 643, DateTimeKind.Local).AddTicks(5647)
                        });
                });
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Flights.FlightReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FlightId = 1,
                            InputDate = new DateTime(2019, 10, 19, 11, 29, 45, 639, DateTimeKind.Local).AddTicks(5284),
                            OutputDate = new DateTime(2019, 10, 29, 11, 29, 45, 641, DateTimeKind.Local).AddTicks(3688)
                        });
                });
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Hotels.HotelReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            InputDate = new DateTime(2019, 10, 19, 11, 29, 45, 643, DateTimeKind.Local).AddTicks(8423),
                            OutputDate = new DateTime(2019, 10, 29, 11, 29, 45, 643, DateTimeKind.Local).AddTicks(8438)
                        });
                });
