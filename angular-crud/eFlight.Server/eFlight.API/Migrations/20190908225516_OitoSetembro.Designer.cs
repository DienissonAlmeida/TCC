...
namespace eFlight.API.Migrations
{
    ...
    [Migration("20190908225516_OitoSetembro")]
    partial class OitoSetembro
    {
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Flights.FlightReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FlightId = 1,
                            InputDate = new DateTime(2019, 9, 8, 19, 55, 15, 615, DateTimeKind.Local).AddTicks(9222),
                            OutputDate = new DateTime(2019, 9, 18, 19, 55, 15, 618, DateTimeKind.Local).AddTicks(4496)
                        });
                });
