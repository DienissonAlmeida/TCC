...
namespace eFlight.API.Migrations
{
    ...
    [Migration("20190410013659_flight")]
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Flights.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Destination = "Paris",
                            Origin = "São Paulo",
                            Out = new DateTime(2019, 4, 9, 22, 36, 58, 839, DateTimeKind.Local).AddTicks(229),
                            Return = new DateTime(2019, 4, 19, 22, 36, 58, 841, DateTimeKind.Local).AddTicks(3169)
                        });
                });
