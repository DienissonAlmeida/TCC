...
namespace eFlight.API.Migrations
{
    ...
    [Migration("20190912230307_12-07")]
    partial class _1207
    {
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Flights.FlightReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FlightId = 1,
                            InputDate = new DateTime(2019, 9, 12, 20, 3, 6, 637, DateTimeKind.Local).AddTicks(3372),
                            OutputDate = new DateTime(2019, 9, 22, 20, 3, 6, 638, DateTimeKind.Local).AddTicks(7750)
                        });
                });
