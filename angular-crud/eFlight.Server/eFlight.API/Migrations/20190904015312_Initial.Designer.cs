...
namespace eFlight.API.Migrations
{
    ...
    [Migration("20190904015312_Initial")]
            ...
            modelBuilder.Entity("eFlight.Domain.Features.Flights.FlightReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FlightId = 1,
                            InputDate = new DateTime(2019, 9, 3, 22, 53, 11, 491, DateTimeKind.Local).AddTicks(8022),
                            OutputDate = new DateTime(2019, 9, 13, 22, 53, 11, 494, DateTimeKind.Local).AddTicks(876)
                        });
                });
